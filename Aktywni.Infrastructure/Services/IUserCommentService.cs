...
namespace Aktywni.Infrastructure.Services
{
    public interface IUserCommentService
    {
        ...
        Task<ReturnResponse> GetCommentsInEvent(int userId, int eventId);
        Task<ReturnResponse> GetCommentsWithUncommentUsersInEvent(int userId, int eventId); // uzyskanie też nieskomentowanych osób
