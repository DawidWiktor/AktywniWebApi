...
namespace Aktywni.Core.Repositories
{
    ...
    {
        Task<UserComments> GetComment(int myId, int userId, int eventId);
        ...
        Task<List<Tuple<int, string, int, string, int, string>>> GetCommentsInEvent(int userId, int eventId);
